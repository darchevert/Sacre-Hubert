...
let punchlinesFav = mongoose.Schema({name: String, punchline: String, photo: String, sound: String, user_id: String});
let punchlinesModel = mongoose.model('punchlinesFav', punchlinesFav);

var userSchema = mongoose.Schema({name: String, email: String, password: String});
...
router.post('/add-fav', function(req, res, next) {
  ...
  console.log(punchlines.name);

  var newFav = new punchlinesModel({name: punchlines.name, punchline: punchlines.punchline, photo: punchlines.photo, sound: punchlines.sound, user_id: req.session.user._id});

  newFav.save(function(error, fav) {
    punchlinesModel.find({
      user_id: req.session.user._id
    }, function(error, punchlinesFav) {
